    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          <Link href="/">Gatego Firmware</Link> UI History
        </h1>

        <p className={styles.description}>
          Here you can download see the previous versions of UI for gatego Unified.
        </p>
        ...
        <table className={styles.grid}>
          {
            releases.map(release => {
              ...
              return <div className={styles.card} key={release.id}>
                ...
                <div className={styles.buttons}><a href={"/api/getRelease/" + release.assetId + "?repo=gatego-unified-screen"} className={styles.a}>Download</a><Link href={"/uifirmware/" + release.id}><a className={styles.a}>View Details</a></Link></div>
              </div>;
